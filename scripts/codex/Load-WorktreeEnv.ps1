...
foreach ($name in $variableNames) {
    ...
    if (Test-SyncFactorsSecureStoreVariableName -VariableName $name) {
        $storedValue = Get-SyncFactorsSecureStoreValue -RepoRoot $repoRoot -EnvFilePath $envFile -VariableName $name
