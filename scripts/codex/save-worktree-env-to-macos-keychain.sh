...
validate_secret_name() {
  local name="$1"
  case "${name}" in
    SF_AD_SYNC_SF_USERNAME|SF_AD_SYNC_SF_PASSWORD|SF_AD_SYNC_SF_CLIENT_ID|SF_AD_SYNC_SF_CLIENT_SECRET|SF_AD_SYNC_AD_SERVER|SF_AD_SYNC_AD_USERNAME|SF_AD_SYNC_AD_BIND_PASSWORD|SF_AD_SYNC_AD_DEFAULT_PASSWORD)
      return 0
      ;;
    *)
