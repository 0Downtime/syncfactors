Describe 'Invoke-SyncFactorsRun' {
    ...
    It 'produces a create-heavy scoped review preview for an active worker with many mapped attributes' {
        InModuleScope Sync {
            ...
            Mock Get-SfWorkerById {
                [pscustomobject]@{
                    ...
                    emailNav = [pscustomobject]@{
                        results = @(
                            [pscustomobject]@{
                                emailAddress = '40618@spireenergy.com'
                            }
                        )
                    }
                }
            ...
            $global:CapturedReport.creates[0].proposedAttributes.UserPrincipalName | Should -Be '40618@spireenergy.com'
            ...
            Assert-MockCalled New-SyncFactorsUser -Times 1 -Exactly -ParameterFilter {
                ...
                $Attributes['UserPrincipalName'] -eq '40618@spireenergy.com'
            }
        }
    }
