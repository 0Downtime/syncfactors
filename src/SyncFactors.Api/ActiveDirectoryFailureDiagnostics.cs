...
public static partial class ActiveDirectoryFailureDiagnostics
{
    ...
    private static string FormatLabel(string key)
    {
        return key switch
        {
            ...
            "LicensingGroups" => "Licensing Groups",
            "ConflictingAttribute" => "Conflicting Attribute",
            "ConflictingValue" => "Conflicting Value",
            "ExistingSamAccountName" => "Existing SAM",
            "ExistingDisplayName" => "Existing Display Name",
            "ExistingDistinguishedName" => "Existing Distinguished Name",
            "ExistingUserPrincipalName" => "Existing UPN",
            "ExistingMail" => "Existing Mail",
