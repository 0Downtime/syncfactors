...
internal static class SourceAttributePathNormalizer
{
    public static string Normalize(string source)
    {
        return source switch
        {
            ...
            "employmentNav[0].jobInfoNav[0].emplStatus" => "emplStatus",
            "employmentNav/jobInfoNav/emplStatus" => "emplStatus",
            "employmentNav[0].jobInfoNav[0].employeeStatus" => "employeeStatus",
            "employmentNav/jobInfoNav/employeeStatus" => "employeeStatus",
            "employmentNav[0].jobInfoNav[0].employeestatus" => "employeestatus",
            "employmentNav/jobInfoNav/employeestatus" => "employeestatus",
